...
private:
    int triangle(float* vertices, glm::vec3 a, glm::vec3 b, glm::vec3 c, int nDepth, float radius, glm::vec3* color);
    int divide_triangle(float* vertices, glm::vec3 a, glm::vec3 b, glm::vec3 c, int n, int depth, float radius, glm::vec3* color);
